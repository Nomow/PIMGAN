...
class PIMGAN(nn.Module):
    ...
    def _setup_renderer(self, cfg):
        self.render = SRenderY(self.image_size, obj_filename=cfg.DECA_kwargs.topology_path, uv_size=cfg.DECA_kwargs.uv_size, rasterizer_type="pytorch3d").to(self.device)
